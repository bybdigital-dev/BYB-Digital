            ...
            {navItems.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(item.href)
                    ? "text-primary"
                    : "text-grey-text hover:text-primary"
                )}
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100 py-4 space-y-2">
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive(item.href)
                    ...
                    : "text-grey-text hover:text-primary hover:bg-gray-50"
                )}
            ...
            <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)} data-testid="link-mobile-contact">
              <Button className="w-full bg-primary text-white hover:bg-primary-dark mt-2">
                Contact
              </Button>
            </Link>
          </div>
